<template>
  <div>
    <div style="height: 300px; overflow: auto; border: 1px solid blue; padding: 30px">
      <div style="height: 80vh"></div>
      <div ref="renderRef" style="height: 400px; overflow: auto; border: 1px solid red">
        <div style="height: 80vh"></div>
        <vue-markdown
          style="border: 1px solid yellow; padding: 10px"
          :src="markdown"
          toc
          :toc-change-hash="false"
          :container="renderRef"
        />
        <div style="height: 80vh"></div>
      </div>
