...
使用 `preset-name` 可以快捷地设置 Markdown 语法规则。内置三种常用预设：
[default](https://github.com/markdown-it/markdown-it/blob/master/lib/presets/default.mjs)（默认预设，类似 GFM），[commonmark](https://github.com/markdown-it/markdown-it/blob/master/lib/presets/commonmark.mjs)（详情[请看](https://commonmark.org/)）和 [zero](https://github.com/markdown-it/markdown-it/blob/master/lib/presets/zero.mjs)（所有语法规则都不会启用）。
